...
\begin{document}
	...
	As a starting point we would like to focus our attention on the roundabout. In our initial design this was the most challenging aspect as any vehicle entering the roundabout will have to give way to vehicles already on the roundabout. Hence it will be most effective to start with this and introduce other junctions at a later date.\\
